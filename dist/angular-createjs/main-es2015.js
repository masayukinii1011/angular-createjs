...
let Canvas01Component = class Canvas01Component {
    constructor() {
        this.rectW = 100;
        this.rectH = 100;
...
let Canvas02Component = class Canvas02Component {
    constructor() {
        this.size = 10;
        this.height = 200;
        this.color = '#FF00FF';
...
let Canvas03Component = class Canvas03Component {
    constructor() {
        this.color = '#ff0000';
        this.red = 0;
        this.green = 0;
...
let Canvas04Component = class Canvas04Component {
    constructor() {
        this.bg1 = '#ff9a9e';
        this.bg2 = '#a18cd1';
        this.scale = 1;
...
class Shape extends createjs_module__WEBPACK_IMPORTED_MODULE_0__["Shape"] {
...
class ShapeGenerator {
    ...
    // 図形生成
    generate(stage, scale, maxLife, gravity) {
